      ...
      <section className="section-box mt-80">
        <div className="container">
          <div className="text-center">
            ...
            <p
              className="font-lg color-text-paragraph-2 wow animate__ animate__fadeInUp animated"
              style={{ visibility: "visible", animationName: "fadeInUp" }}
            >
              ...
              <div className="card-image-top hover-up">
                <a href="jobs-grid.html">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(https://media.istockphoto.com/id/186255464/photo/bangalore-skyline-india.jpg?s=2048x2048&w=is&k=20&c=evNdGo_ASdcKWmTp9qw3SxI7qMYdjpqU8cEbjby4Amg=)",
                    }}
                  >
